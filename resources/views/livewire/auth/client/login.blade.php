<div class="flex justify-center items-center min-h-screen">
    <div class="glossy-bg p-8 w-96 rounded-lg shadow-lg">
        ...
        <p class="mt-4 text-center">
            ...
            <a href="javascript:void(0);" wire:click.prevent="openRegistrationForm" class="text-blue-500 text-decoration-none">
                Register
            </a>
        </p>
        @endif
        ...
        <form wire:submit.prevent="register">
            <div class="mb-4">
                ...
                <input wire:model="name" type="text" class="w-full p-2 mt-2 border border-gray-300 rounded-lg"
        ...
        <p class="mt-4 text-center">
            Already have an account? <a href="javascript:void(0);" wire:click.prevent="openLoginForm"
